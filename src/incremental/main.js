    ...
    YooA: {
        upgrades: {
            ...
            11: {
                ...
                description() {
                  return "Add 1 more digit to math problems but gain 2x more YooA Points."
                },
                cost() {
                ...
                effect() {
                  return Decimal.pow(2, getUpgLevels("YooA", 11));
                },
                effectDisplay() {
            ...
            22: {
                title: "YooA Doubler (YU 22)",
                description() { 
                  return "Double YooA Point gain."
                },
                cost() {
                  return Decimal.pow(3, getUpgLevels("YooA", 22).pow(1.3)).mul(1e10);
                },
                costCurrency: "YooA Points",
                costInternal: "YooAPoints",
                effect() {
                  return Decimal.pow(2, getUpgLevels("YooA", 22));
                },
                effectDisplay() {
                  return "x" + format(this.effect());
                },
