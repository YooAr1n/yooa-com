<template>
  <div class="options">
    ...
    <button id="autosave" @click="autoSave()">Auto Save: ON</button>
    <button id="autoint" @click="changeAutoInt()">Auto Save interval: 1s</button>
  </div>
</template>

<script>
import { options, autoSave, changeAutoInt } from "@/incremental/options.js";
